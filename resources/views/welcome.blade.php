...
@section('styles')
    <!-- CSS only -->
    <link rel="stylesheet" href="<?php echo asset('css/partials/welcome.css')?>" type="text/css">
    <link rel="stylesheet" href="<?php echo asset('css/partials/sliders.css')?>" type="text/css">
...
@include('partials.home.cursos')
<main>
@include('partials.home.detalles')
</main>
@include('partials.home.metas')
@include('partials.home.estudiante')
@include('partials.home.banner')
@include('partials.home.comentarios')
@endsection
@section('scripts')
