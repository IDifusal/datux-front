@extends('master')
@section('styles')
<link rel="stylesheet" href="<?php echo asset('css/cursos-live.css')?>" type="text/css">
...
<div class=" mb-5 pb-5 pt-5 mt-5 card-slider" style="">
			...
			<div class="row" data-aos="fade-up">
				<div class="col-md-4">
					<div class="card main1 mb-md-3 mt-md-3" style="width: 100%;">
						<img class="card-img-top" src="/img/2.png" width="100%" height="" alt="Card image cap">
						...
						<div class="card-body pb-0">
							...
							<span class="span-autor" style="color: #617289;"> 6hrs</span>
						</div>
					</div>
				</div>
				<div class="col-md-4">
